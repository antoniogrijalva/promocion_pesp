            ...
            <form @submit.prevent="guardarEmpleado" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 m-4">
                    <div>
                        ...
                        <label class="block mb-0 text-xs mt-3 ">Nombre:</label>
                        <input v-model="empleado.nombre" type="text" class="w-full text-sm border border-gray-300 px-3 py-1 rounded" required>
                 
                        <label class="block mb-0 text-xs mt-3 ">Primer Apellido:</label>
                        <input v-model="empleado.primer_apellido" type="text" class="w-full text-sm border border-gray-300 px-3 py-1 rounded" >
                   
                        <label class="block mb-0 text-xs mt-3 ">Segundo Apellido:</label>
                        <input v-model="empleado.segundo_apellido" type="text" class="w-full text-sm border border-gray-300 px-3 py-1 rounded" >
                    </div>


                    <div>
                        <label class="block mb-0 text-xs mt-3 ">Fecha de Nacimiento:</label>
                        <input v-model="empleado.fecha_nacimiento" type="date" class="w-full text-sm border border-gray-300 px-3 py-1 rounded" required>

                        <label class="block mb-0 text-xs mt-3 ">CURP:</label>
                        <input v-model="empleado.curp" type="text" class="w-full text-sm border border-gray-300 px-3 py-1 rounded" required>

                         <label class="block mb-0 text-xs mt-3 ">Email:</label>
                        <input v-model="empleado.email" type="email" class="w-full text-sm border border-gray-300 px-3 py-1 rounded" >

                         <label class="block mb-0 text-xs mt-3 ">Teléfono:</label>
                        <input v-model="empleado.telefono" type="tel" class="w-full text-sm border border-gray-300 px-3 py-1 rounded" >
                    </div>
                    
                    
                    <div class="">

                        <label class="block mb-0 text-xs mt-3 ">Fecha de Ingreso:</label>
                        <input v-model="empleado.fecha_ingreso" type="date" class="w-full text-sm  border border-gray-300 px-3 py-1 rounded" required>

                        <div class="flex mt-4 space-x-4 justify-between items-center _bg-red-100 p-2 rounded  border border-red-300 "> 
                            <div >
                                <label class="block mb-0 text-xs mt-3 ">Baja:</label>
                                <input v-model="empleado.baja" type="checkbox" class="rounded">
                            </div>
                        
                            <!-- <label class="block mb-0 text-xs mt-3 ">Fecha de Baja:</label> -->
                            <input v-model="empleado.baja_fecha" type="date" class="w-2/3 text-sm border border-gray-300 px-3 py-1 rounded">
                        </div>
                                                                      
                        <div class="mt-3 bg-slate-200  border border-gray-300  p-2 rounded">
                            <label class="block mb-0 text-xs mt-3 ">Puesto:</label>
                            <select v-model="empleado.puesto" class="w-full text-sm border border-gray-300 px-3 py-1 rounded" required>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-2">
                     ...
                     <div class="border border-gray-200 rounded p-2">
                        ...
                        <div>
                            <label class="block mb-0 text-xs mt-7 ">Fecha:</label>
                            <input v-model="empleado.acreditacion_formacion_fecha" type="date" class="w-full text-sm border border-gray-300 px-3 py-1 rounded">
                        </div>
                    </div>
                    ...
                    <div class="border border-gray-200 rounded p-2">
                        ...
                        <div>
                            <label class="block mb-0 text-xs mt-3 ">Fecha Acreditación:</label>
                            <input v-model="empleado.acreditacion_cuip_fecha" type="date" class="w-full text-sm border border-gray-300 px-3 py-1 rounded">
                        </div>
 
                        <div>
                            <label class="block mb-0 text-xs mt-3 ">Fecha Vigencia:</label>
                            <input v-model="empleado.acreditacion_cuip_vigencia" type="date" class="w-full text-sm border border-gray-300 px-3 py-1 rounded">
                        </div>
                    </div>
                    ...
                    <div class="border border-gray-200 rounded p-2">
                        ...
                        <div>
                            <label class="block mb-0 text-xs mt-7 ">Fecha:</label>
                            <input v-model="empleado.acreditacion_competencias_fecha" type="date" class="w-full text-sm border border-gray-300 px-3 py-1 rounded">
                        </div>

                        <div>
                            <label class="block mb-0 text-xs mt-3 ">Fecha Vigencia:</label>
                            <input v-model="empleado.acreditacion_competencias_vigencia" type="date" class="w-full text-sm border border-gray-300 px-3 py-1 rounded">
                        </div>
                        <div>
                            <label class="block mb-0 text-xs mt-3 ">Calificación Competencias:</label>
                            <input v-model="empleado.acreditacion_competencias_calificacion" type="number" step="0.01" class="w-full text-sm border border-gray-300 px-3 py-1 rounded">
                        </div>
                    </div>
                    ...
                    <div class="border border-gray-200 rounded p-2">
                        ...
                        <div>
                            <label class="block mb-0 text-xs mt-7 ">Fecha:</label>
                            <input v-model="empleado.acreditacion_desempeno_fecha" type="date" class="w-full text-sm border border-gray-300 px-3 py-1 rounded">
                        </div>
                        <div>
                            <label class="block mb-0 text-xs mt-3 ">Fecha Vigencia:</label>
                            <input v-model="empleado.acreditacion_desempeno_vigencia" type="date" class="w-full text-sm border border-gray-300 px-3 py-1 rounded">
                        </div>
                        <div>
                            <label class="block mb-0 text-xs mt-3 ">Calificación Desempeño:</label>
                            <input v-model="empleado.acreditacion_desempeno_calificacion" type="number" step="0.01" class="w-full text-sm border border-gray-300 px-3 py-1 rounded">
                        </div>
                    </div>
                     ...
                     <div class="border border-gray-200 rounded p-2">
                        ...
                        <div>
                            <label class="block mb-0 text-xs mt-7 ">Fecha:</label>
                            <input v-model="empleado.acreditacion_c3_fecha" type="date" class="w-full text-sm border border-gray-300 px-3 py-1 rounded">
                        </div>

                        <div>
                            <label class="block mb-0 text-xs mt-3 ">Fecha Vigencia:</label>
                            <input v-model="empleado.acreditacion_c3_vigencia" type="date" class="w-full text-sm border border-gray-300 px-3 py-1 rounded">
                        </div>
              
                        <div>
                            <label class="block mb-0 text-xs mt-3 ">Observaciones C3:</label>
                            <textarea v-model="empleado.acreditacion_c3_observaciones" rows="3" class="w-full  border border-gray-300 px-3 py-1 rounded text-xs text-indigo-600"></textarea>
                        </div>
                    </div>
